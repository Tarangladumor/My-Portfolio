import Introduction from '../components/common/Introduction/Index';
...
export default function HomeLayout({ children }) {
  ...
  return (
    <div className={`h-screen lg:p-[0.8rem] flex flex-col select-none font-circular text-white`}>
      ...
      <div className='flex relative h-full justify-between gap-x-3'>
        ...
        <div
          ...
          <Introduction isOpen={intro} setIsOpen={setIntro} />
        </div>
        {/* overlay */}
